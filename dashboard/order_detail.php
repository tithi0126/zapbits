...
<div class='p-6 animate__animated' x-data='pagination'>
	<h1 class="dark:text-white-dar  pb-8 text-3xl font-bold">Order Detail</h1>
	<div class="panel mt-6 flex items-center  justify-between relative">
		...
		<button type="button" class="p-2 btn btn-primary m-1 add-btn" onclick="javascript:add_data()">
			<i class="ri-add-line mr-1"></i>Order</button>
            ...
            Alpine.data('pagination', () => ({
                ...
                init() {
                    this.datatable = new simpleDatatables.DataTable('#myTable',{
                        data: {
                            headings: ['Sr.No.','Order Id','Details','Price','GST','GST Amount','Quantity', 'Action'],
                            data: [
                                <?php
                                $stmt = $obj->con1->prepare("SELECT * FROM `order_detail`");
                                $stmt->execute();
