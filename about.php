...
<main>
    ...
    while ($row = mysqli_fetch_array($Resp)) {
        ...
        <div class="page-banner-area page-banner-height"
            data-background="dashboard/images/about/<?php echo $row["image"] ?>">
            <?php echo $row["image"] ?>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-banner-content text-center">
                            <h3>About Us</h3>
                            <p><?php echo addslashes($row["description"]); ?></p>
                            <div class="page-bottom-btn mt-55">
                                <a href="index.html" class="st-btn-4">Discover now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="about-content">
                            ...
                            <p class="about-text">Over 25 years Dukamarket helping companies reach their <br> financial and
                                branding goals.</p>
                            <p>The perfect way to enjoy brewing tea on low hanging fruit to identify. Duis autem vel eum
                                ...
                                feugiat nulla facilisis. For me, the most important part of improving at photography.</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="abs-section-title text-center">
                            ...
                            <p>The perfect way to enjoy brewing tea on low hanging fruit to identify. Duis autem vel eum
                                iriure dolor in hendrerit <br> in vulputate velit esse molestie consequat, vel illum dolore
                ...
                <div class="row mt-40">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-item mb-30">
                            ...
                            <p>Sed ut perspiciatis unde omnis iste natus error sit accusantium doloremque laudantium totam
                                rem aperiam, eaqueipsa quae veritatis.</p>
