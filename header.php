...
$stmt_cat = $obj->con1->prepare("SELECT * FROM `product_category`");
$stmt_cat->execute();
$data_cat = $stmt_cat->get_result();

$stmt_cat->close();

$stmt_srch_cat = $obj->con1->prepare("SELECT * FROM `product_category`");
$stmt_srch_cat->execute();

$srch_cat = $stmt_srch_cat->get_result();
$stmt_srch_cat->close();
?>
<!doctype html>
<html class="no-js" lang="zxx">

    <!-- Mirrored from wphix.com/template/dukamarket/dukamarket/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 May 2024 11:18:03 GMT -->

    <head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Welcome to ZAPbits</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                                <div class="header__info">
                                    <div class="logo">
                                        <a href="#" class="logo-image"><img src="assets/img/logo/logo1.svg"
                                                alt="logo"></a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="header__search-cat">
                                            <select>
                                                ...
                                                <?php
                                                while ($category_srch = mysqli_fetch_array($srch_cat)) {
                                                    ?>
                                ...
                                <div class="cat-toggle">
                                    ...
                                    <div class="cat__menu">
                                        <nav id="mobile-menu" style="display: block;">
                                            <ul>
                                                <?php
                                                while ($category = mysqli_fetch_array($data_cat)) {
                                                    ?>
